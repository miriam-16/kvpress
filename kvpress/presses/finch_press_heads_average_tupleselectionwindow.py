...
@dataclass
class FinchPressTWSHavg(BasePress):
    """
    ...
    def compress(
        ...
        for token in important_tokens:
            ...
            #if extreme cases, move the window to the left or right
            ...
            common = head_kept_tuple_indices & indices_set  #compute intersection
            ...
            if current_num_tokens+to_add<n_kept_context and to_add!=0:
                    ...
                    head_kept_tuple_indices.update(list(indices_set))
                    ...
                    head_kept_tuple_indices.update(random_elements)
