...
context = "[<header>[t1,t2,t3,t4]<header>[1, 2, 3,4]<tuple_end>[4, 5, 6, 4]<tuple_end>[7, 8, 9, 4]<tuple_end>[10, 11, 12, 4]<tuple_end>[13, 14, 15, 4]<tuple_end>[16, 17, 18, 4]<tuple_end>[19, 20, 21, 4]<tuple_end>]"
question= "come stai?"
...
press= FinchPressKeepStructuralTokensForTSHAvg(compression_ratio=0.8, split_size=1)
