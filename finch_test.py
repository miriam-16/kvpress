...
from kvpress import FinchPress, KeyRerotationPress, SnapKVPress, FinchPressTSNaive,FinchPressWTS, FinchPressWCS,FinchPressTCSNaive, FinchPressTSHavg
...
press= FinchPressTSHavg(compression_ratio=0.8, split_size=1)
